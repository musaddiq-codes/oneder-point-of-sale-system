                ...
                <div>
                    <nav>
                        <ul>
                            ...
                            <NavLink to='/dishes' style={{ textDecoration: 'none' }}><Button style={{ marginLeft: '25px', backgroundColor: '#3639CF', borderRadius: '20px', color: 'white', textDecoration: 'none' }} >Home</Button></NavLink>
