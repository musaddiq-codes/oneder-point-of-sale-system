      ...
      <AppBar position="static" sx={{ backgroundColor: '#000312' }}>
        <StyledToolBar >
          ...
          <div>
            ...
            <NavLink to='/getcategory' style={{ textDecoration: 'none' }}><Button sx={{ width: '100px', backgroundColor: '#583AAB', marginLeft: '20px', borderRadius: '20px', color: 'white' }}>Get Category</Button></NavLink>
            ...
            <NavLink to='/dishes' style={{ textDecoration: 'none' }}><Button sx={{ width: '100px', backgroundColor: '#583AAB', marginLeft: '20px', borderRadius: '20px', color: 'white' }}>Deshboard</Button></NavLink>
