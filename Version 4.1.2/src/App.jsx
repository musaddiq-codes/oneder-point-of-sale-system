...
import TreeViewPage from './pages/TreeViewPage/TreeViewPage'
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/deshboard" element={<DeshboardHeader toggleTheme={props.toggleTheme} themeStyles={props.themeStyles} />}>
            ...
            <Route path="/deshboard/categories" element={<Categories />} />
            <Route path="/deshboard/treeviewpage" element={<TreeViewPage />} />
