...
import Demos from '../../../Library/SideMenu/SideMenu'
      ...
      <AppBar position="static" sx={{ backgroundColor: '#000312' }}>
        <StyledToolBar >
          ...
          <div>
            ...
            <NavLink to='/deshboard/allforms' style={{ textDecoration: 'none' }}><Button sx={{ width: '100px', backgroundColor: '#583AAB', marginLeft: '20px', borderRadius: '20px', color: 'white' }}>Catagaries</Button></NavLink>
