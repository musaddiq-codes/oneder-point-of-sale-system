...
function SignUp() {
  ...
  const handleSubmit = (event) => {
    ...
    const form = {
      ...
      cat_description: data.get('description'),
      cat_parent_id: 0,
      cat_color: data.get('color'),
  ...
  return (
    <>
      <ThemeProvider theme={theme}>
        <Container component="main" sx={{ width: "70%", backgroundColor: 'white' }}>
          {/* <Container component="main" maxWidth="xs" sx={{ backgroundColor: "pink", width: "200%" }}> */}
          <CssBaseline />
          <Box
            sx={{
              marginTop: 0,
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
              ...
              <button type='submi'>submit</button>     {/* <Grid container justifyContent="flex-end">
                <Grid item>
